        ...
        private function build_header($title,$link){
            ...
            <nav class="navTop">
                ...
                <div class="groupBtn">
                    ...
                    <div class="user">
                        <div class="cover">
                            <img src="images/avatar/'.$_SESSION[SESSION_NAME]['avatar'].'" alt="cover" />
                        </div>
                        <div class="userName">
                            <p>'.$_SESSION[SESSION_NAME]['nom'].'</p>
                        </div>
                    </div>
                    <button class="login">
                    ...
                    <div class="shopFrontOffice">
                        <button class="shop">
                            <a href="index.php?page=fo_home"><p>Boutique</p></a>
                        </button>
                        </div>
                    </div>
                </div>
            ...
            <div class="sideNav">
                <nav class="navLateral">
                    <div class="buttonGroupNav">
                        <button class="photo">
                            <a href="index.php?page=home"><i class="bx bx-image-alt"></i></a>
                        </button>
                        <button class="user">
