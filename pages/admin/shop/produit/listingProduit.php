...
// Formulaire d'ajout
$html .= '<form action="pages/shop/produit/manageProduit.php " method="POST" enctype="multipart/form-data">';
...
$html .= '<select name="rayon" id="rayon">';
...
if(empty($datas_produit)){
    ...
    foreach($datas_produit as $produit) {
        ...
        $html .= '</td>';
        $html .= '<td class="res-head">';
        $html .= '<span>' . $_SESSION[SESSION_NAME]['nom'] . '</span>';
        $html .= '</td>';
        $html .= '<td class="res-head">';
