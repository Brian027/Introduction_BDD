...
// Formulaire d'ajout
$html .= '<form action="pages/user/manageUser.php" method="POST" enctype="multipart/form-data">';
...
foreach ($datas_user as $data) {
    ...
    $html .= '<a href="index.php?page=listing_user&id=' . $data['id'] . '" onclick="return confirm(\'Etes vous sur de vouloir supprimer cet utilisateur ?\')"><i class="bx bx-trash"></i></a>';
    $html .= '</td>';
    $html .= '</tr>';
    $html .= '</tbody>';
}
